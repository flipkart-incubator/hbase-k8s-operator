...
func (in *HBasePodDisruptionBudget) DeepCopyInto(out *HBasePodDisruptionBudget) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HBasePodDisruptionBudget.
func (in *HBasePodDisruptionBudget) DeepCopy() *HBasePodDisruptionBudget {
	if in == nil {
		return nil
	}
	out := new(HBasePodDisruptionBudget)
	in.DeepCopyInto(out)
	return out
}
